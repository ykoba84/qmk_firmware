...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   * | Shift|   Z  |   X  |   C  |   V  |   B  |   [  |   ]  |   N  |   M  |   ,  |   .  |   /  |  '   |
   * |------+------+------+------+------+------+------+------+------+------+------+------+------+------|
   * |Adjust|ADJUST| Alt  | GUI  | EISU |Lower |Space |Space |Raise | KANA | Left | Down |  Up  |Right |
   * `-------------------------------------------------------------------------------------------------'
   */
  [_QWERTY] = LAYOUT( \
      ...
      ADJUST,  ADJUST,  KC_LALT, KC_LGUI, RAISE,   EISU,   KC_SPC,  KC_SPC,  KANA,   LOWER,    KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT \
      ),
  ...
  [_RAISE] = LAYOUT( \
      ...
      _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_BSPC, \
